...
- You have to have a VPS/Homelab/Raspberry Pi.
    ...
    - If you do not have a VPS, [Stuxhost](https://stuxhost.com/) 🇪🇺, [Ploxhost](https://plox.host/vps-hosting) 🇺🇸, [Vultr](https://www.vultr.com/) 🌐, and [Cockbox](https://cockbox.org/) 🇱🇹 are good options.
